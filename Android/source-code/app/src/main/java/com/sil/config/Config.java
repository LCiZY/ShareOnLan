...
public class Config {
    ...
    public static final String ROOTDIROTERYNAME = "ShareOnLan";
    public static final String APPROOTDIR = Environment.getExternalStorageDirectory().getPath() + File.separator + ROOTDIROTERYNAME;
    public static final String TODIRRETORY = APPROOTDIR+File.separator ;
    public static final String CONFIGFILENAME = "config.ini";


    public static final String RECEIVEFILEDIRETORY = TODIRRETORY+"ReceiveFiles"+File.separator  ;
    static {
