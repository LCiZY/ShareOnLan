...
public class ArrowDownloadButton extends View {
    ...
    private static final int ARC_COLOR = Color.rgb(255,255,255);
    private static final int THEME_COLOR = Color.rgb(163, 193, 253);
    private static final int ARROW_COLOR = Color.rgb(76, 234, 194);
